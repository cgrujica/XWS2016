...
public class ExportService {
	...
	@POST
	@Consumes(MediaType.APPLICATION_XML)
	public String exportAsPDF(@PathParam("id") String id) throws SAXException, IOException, JAXBException {
		
		EntityManagerMarkLogic<Zakon, Long> em = new EntityManagerMarkLogic<Zakon, Long>("", "src.rs.gov.parlament.propisi");
		Zakon z = em.getZakonByID(id);
	...
	@POST
	@Consumes(MediaType.APPLICATION_XML)
	public String exportAsXHTML(@PathParam("id") String id) throws SAXException, IOException, JAXBException {
